                ...
                <div class="bg-white relative pb-2 pt-3 mb-1 shadow">
                    ...
                    <div class="flex ml-3">
                        <div class="bg-blue-700 aspect-square h-10 overflow-hidden rounded-full">
                            <a href="#">
                             <img class="h-full w-full object-cover" src="../img/{{-- $source; --}}" alt=""> </a>
                        </div>
                        <a href="#" class="font-semibold text-sm my-auto ml-1 text-gray-800">{{-- $fullname --}} fullname</a>
                    </div>

                    <!-- menu, Start-->
                    <div class="absolute right-4 top-2">
                        <!-- Titik tiga [menu], Start -->
                        <button id="dropdownMenuIconHorizontalButton" data-dropdown-toggle="dropdownDotsHorizontal{{-- $id_tanya --}}" class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-700 bg-white rounded-lg hover:bg-gray-100 focus" type="button">
                        ...
                        <!-- Dropdown menu, Start-->
                        <div id="dropdownDotsHorizontal{{-- $id_tanya --}}" class="z-10 hidden bg-white opacity-90 divide-y divide-gray-100 rounded-lg shadow drop-shadow w-[12rem]">
                            ...
                            <div data-modal-target="popup-hapus" data-modal-toggle="popup-hapus{{-- $id_tanya --}}" class="flex px-3 py-2 text-sm text-[#FF1A1A] hover:bg-gray-100 cursor-pointer" type="button">
                        ...
                        <div id="popup-hapus{{-- $id_tanya --}}" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow">
                                    <div class="p-6 text-center">
                                        ...
                                        <button data-modal-hide="popup-hapus" {{-- onclick="location.href='edit/deltanya.php?id={{ $id_tanya }}'" --}} type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                            Iya
                                        </button>
                    ...
                    <div class="mx-5 mt-2 grid">
                        <span class="font-bold text-gray-900">{{-- $pertanyaan --}}
                            ...
                            <button data-modal-target="lihat-gambar" data-modal-toggle="lihat-gambar{{-- $id_tanya --}}" 
                        ...
                        <!-- Main modal -->
                        <div id="lihat-gambar{{-- $id_tanya --}}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        ...
                        <span class="font-semibold text-sm mt-1 text-gray-700">{{-- $komen --}}</span>

                    </div>
                    <!-- Tombol Jawaban, Start -->
                    <button data-modal-target="defaultModal" data-modal-toggle="defaultModal{{-- $id_tanya --}}" class="border-2 my-2 w-32 rounded-lg py-2 ml-4 cursor-pointer bg-white hover:bg-gray-100" type="button">
                    ...
                    <div id="defaultModal{{-- $id_tanya --}}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-[89%] md:w-[80%] h-[40rem]">
                            ...
                            <div style="background-color: rgba(230, 230, 230, 0.712);" class="border-slate-700 border-2 grid grid-cols-1 md:grid-cols-2 gap-[0.10rem] md:gap-4 rounded-lg overflow-hidden">
                                ...
                                <div class="col-span-1 bg-white my-auto md:mx-2 rounded-t-md md:rounded-md container">
                                    ...
                                    <div class="flex ml-2 mt-2 w-44">
                                        <div class="bg-gray-500 aspect-square h-9 overflow-hidden rounded-full">
                                            <img class="h-full w-full object-cover" src="../img/{{-- $pp_user --}}" alt="">
                                        </div>
                                    ...
                                    <div class="flex justify-center my-2 mx-1">
                                        ...
                                        <input type="hidden" name="id_tanya" value="{{-- $id_tanya --}}">
                                    </div>
                                ...
                                <div class="col-span-1 bg-white border-l overflow-auto h-[40rem]">
                                    ...
                                    {{-- $jawab_orang = mysqli_query($conn,"SELECT user.fullname, user.foto_profil, jawab.jawaban, jawab.gambar_jawab FROM jawab JOIN user ON jawab.id_user=user.id_user WHERE id_tanya = $id_tanya") --}}

                                    <div class="mt-4">
                                        <!-- Foto Profile -->
                                        <a class="flex ml-2 mt-2 w-44" href="#">
                                            <div class="bg-gray-500 aspect-square h-9 overflow-hidden rounded-full">
                                                <img class="h-full w-full object-cover" src="../Img/{{-- $jawab_source --}}" alt="">
                                            </div>
                                            <span class="text-xs md:text-sm my-auto ml-2 text-gray-700 font-bold">{{-- $jawab_nama --}}</span>
                                        </a>
